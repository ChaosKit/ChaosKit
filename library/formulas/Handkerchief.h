#ifndef CHAOSKIT_LIBRARY_FORMULAS_HANDKERCHIEF_H
#define CHAOSKIT_LIBRARY_FORMULAS_HANDKERCHIEF_H

#include "library/Formula.h"

namespace chaoskit::library {

class Handkerchief : public Formula {
 public:
...
#endif  // CHAOSKIT_LIBRARY_FORMULAS_HANDKERCHIEF_H
